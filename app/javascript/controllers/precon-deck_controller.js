...
// Connects to data-controller="precon-deck"
export default class extends Controller {
  ...
  updateViewModeButtons() {
    if (this.hasViewModeListTarget && this.hasViewModeCardTarget) {
      ...
      this.viewModeListTarget.classList.toggle("bg-accent-50/20", listActive);
      this.viewModeListTarget.classList.toggle("text-accent-50", listActive);
      ...
      this.viewModeCardTarget.classList.toggle("bg-accent-50/20", cardActive);
      this.viewModeCardTarget.classList.toggle("text-accent-50", cardActive);
