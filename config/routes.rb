Rails.application.routes.draw do
  ...
  # the sets area's landing page - every set this collection touches, ranked by completion
  get 'collections/:username/sets', to: 'collection_sets#index', as: :collection_sets
